...
$ docker run -dit --privileged --net custom_net --ip 10.0.0.2 -dit --name dev centos:7 /usr/sbin/init
...
# --hostname ubuntu
设置ip
docker run -dit --privileged --net custom_net --ip 10.0.0.3 --hostname ubuntu -dit --name test1 centos-gpdb /usr/sbin/init


# 基于新镜像启动容器
将该句加入每一个的中间  增加/etc/hosts
# --add-host mdw:10.0.0.3 --add-host sdw1:10.0.0.4 --add-host sdw2:10.0.0.5 --add-host sdw3:10.0.0.6
docker run -dit --privileged -v /tmp:/tmp -p 5432:5432 -p 28080:28080 --net custom_net --ip 10.0.0.13 --hostname mdw -dit --add-host mdw:10.0.0.13 --add-host sdw1:10.0.0.14 --add-host sdw2:10.0.0.15 --add-host sdw3:10.0.0.16 --name mdw centos-gpdb /usr/sbin/init
docker run -dit --privileged -v /tmp:/tmp --net custom_net --ip 10.0.0.14 --hostname sdw1 -dit --add-host mdw:10.0.0.13 --add-host sdw1:10.0.0.14 --add-host sdw2:10.0.0.15 --add-host sdw3:10.0.0.16 --name sdw1 centos-gpdb /usr/sbin/init
docker run -dit --privileged -v /tmp:/tmp --net custom_net --ip 10.0.0.15 --hostname sdw2 -dit --add-host mdw:10.0.0.13 --add-host sdw1:10.0.0.14 --add-host sdw2:10.0.0.15 --add-host sdw3:10.0.0.16 --name sdw2 centos-gpdb /usr/sbin/init
docker run -dit --privileged -v /tmp:/tmp --net custom_net --ip 10.0.0.16 --hostname sdw3 -dit --add-host mdw:10.0.0.13 --add-host sdw1:10.0.0.14 --add-host sdw2:10.0.0.15 --add-host sdw3:10.0.0.16 --name sdw3 centos-gpdb /usr/sbin/init
...
gpinitsystem -c /home/gpadmin/conf/gpinitsystem_config -h /home/gpadmin/conf/hostfile_gpssh_segonly
